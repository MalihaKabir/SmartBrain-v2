...
5. *Also, clone and run **[SmartBrain-backend-API](https://github.com/MalihaKabir/smartbrain-backend-api/blob/master/README.md)** to connect this app with its backend part.*
